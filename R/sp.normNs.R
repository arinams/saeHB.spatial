...
#'
#' This data contains \code{NA} values that indicates no sampled at one or more regions. It uses the \code{sp.norm} with the direct estimators and the related variances of 5 regions are missing.
#'
